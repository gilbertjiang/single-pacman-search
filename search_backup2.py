...
def depthFirstSearch(problem):
    ...
    while not nodesToVisit.isEmpty():
        ...
        #print "problem.getSuccessors(currentState)", problem.getSuccessors(currentState[0])
        """ case 1: currentState is Goal
        """
        if(problem.isGoalState(currentState) == True):
            """ return actions """
            print "Found the goal state!"
            break
        #case 2: currentState is not Goal and it has successors
        elif problem.getSuccessors(currentState[0]):
            print "building nodesToVisit"
            """ move all successors of currentState to nodesToVisit """
            ...
            #return actions
        """
        case 3: currentState is not Goal and it does not have any successor
        """
        #elif problem.getSuccessors(currentState[0]):
        #    ;
